...
<?php if array_key_exists('restart_inprogress', $opcache_stats) { ?>
# HELP php_opcache_restart_inprogress_boolean Indicates if a cache restart is in progress.
# TYPE php_opcache_restart_inprogress_boolean gauge
php_opcache_cache_restart_inprogress_boolean <?php echo $opcache_stats['restart_inprogress'] ? '1' : '0' ?>
<?php } ?>
...
php_opcache_statistics_cached_keys_count <?php echo $opcache_stats['opcache_statistics']['max_cached_keys'] ?>
